...
- Completed: 55 · In Review: 1 · In Progress: 0 · Not Started: 34 · Blocked: 2
...
- `[!]` **T36.2** `M` Writer — Extend Ch. 3 methodology to cover Narwhal+Tusk (blocked: no Narwhal+Tusk implementation task scheduled)
